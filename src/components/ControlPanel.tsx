...
export function ControlPanel({
  ...
  return (
    <div
      className={`rounded-2xl backdrop-blur-sm border p-6 space-y-5 ${
        isDark
    ...
    >
      ...
      <div>
        ...
        >
          ...
          <span className={`${isDark ? "text-slate-500" : "text-slate-500"}`}>
            Previous iterates for acceleration
          </span>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            onToleranceChange(Math.pow(10, parseInt(e.target.value)))
          }
          className="w-full slider"
        />
        <div
      ...
      <div>
        <label
          className={`block text-sm mb-3 font-medium ${isDark ? "text-slate-300" : "text-slate-700"}`}
        >
          Algorithms
        </label>
